...
export default function ValidationError({ errorType }: ValidationErrorProps) {
  ...
  const errorMessages = {
    RESTAURANT_NOT_FOUND: {
      ...
      detail: "Por favor verifica el enlace o código QR",
    },
    BRANCH_NOT_FOUND: {
      title: "Sucursal no encontrada",
      description: "Esta sucursal no existe o no está activa",
      detail: "Por favor verifica el enlace o selecciona otra sucursal",
    },
    NO_BRANCHES: {
    ...
    SERVICE_NOT_AVAILABLE: {
      ...
      description: "Este restaurante no tiene habilitado el servicio Pick-n-Go",
